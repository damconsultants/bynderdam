...
use DamConsultants\BynderDAM\Model\ResourceModel\Collection\BynderConfigSyncDataCollectionFactory;
...
class MassDeleteSyncData extends Action
{
     ...
     * @param \DamConsultants\BynderDAM\Model\BynderConfigSyncDataFactory $bynderFactory
     */
    public function __construct(
        Context $context,
        Filter $filter,
        BynderConfigSyncDataCollectionFactory $collectionFactory,
        \DamConsultants\BynderDAM\Model\BynderConfigSyncDataFactory $bynderFactory
    ) {
        $this->filter = $filter;
