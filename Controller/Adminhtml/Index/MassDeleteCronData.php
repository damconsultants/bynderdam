...
use DamConsultants\BynderDAM\Model\ResourceModel\Collection\BynderDeleteDataCollectionFactory;
...
class MassDeleteCronData extends Action
{
    ...
    public function __construct(
        ...
        \DamConsultants\BynderDAM\Model\BynderDeleteDataFactory $bynderFactory
    ) {
        $this->filter = $filter;
