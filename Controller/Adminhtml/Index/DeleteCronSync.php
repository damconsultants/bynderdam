...
class DeleteCronSync extends Action
{
     ...
     * @param DamConsultants\BynderDAM\Model\BynderDeleteDataFactory $BynderSycDataFactory
     */
    public function __construct(
        Context $context,
        \DamConsultants\BynderDAM\Model\BynderDeleteDataFactory $BynderSycDataFactory
    ) {
