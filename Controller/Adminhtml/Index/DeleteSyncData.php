...
class DeleteSyncData extends Action
{
     ...
     * @param DamConsultants\BynderDAM\Model\BynderConfigSyncDataFactory $BynderConfigSyncDataFactory
     */
    public function __construct(
        Context $context,
        \DamConsultants\BynderDAM\Model\BynderConfigSyncDataFactory $BynderConfigSyncDataFactory
    ) {
