<?php
namespace DamConsultants\BynderDAM\Block\Adminhtml\Catalog\Product\Form;
...
class Gallery extends \Magento\Backend\Block\Template
{
     ...
     * @param \DamConsultants\BynderDAM\Helper $helper
     */
    public function __construct(
        ...
        \DamConsultants\BynderDAM\Helper\Data $helper
    ) {
    ...
    {
        return $this->getViewFileUrl('DamConsultants_BynderDAM::images/drag.png');
    }
    /**
     * Image.
     *
    ...
    {
        return $this->getViewFileUrl('DamConsultants_BynderDAM::images/delete_.avif');
    }
    /**
     * Json.
     *
